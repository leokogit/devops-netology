...
|Вопрос|Ответ|
|------------|----|
|Какой тип инфраструктуры будем использовать для этого проекта: изменяемый или не изменяемый?| Изменяемый, как следует из описания : не чёткое ТЗ, доработки, корректировки, расширение |
...
**2)**
Packer, Terraform, Docker, Ansible, Kubernetes, Teamcity
**3)**
